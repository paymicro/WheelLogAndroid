    ...
    private Response handleData() {
        ...
        try {
            ...
            if (WheelData.getInstance().getAdapter() instanceof KingsongAdapter) {
                ...
                data.put("" + GarminConnectIQ.MESSAGE_KEY_ALARM1_SPEED, adapter.getKSAlarm1Speed());
                data.put("" + GarminConnectIQ.MESSAGE_KEY_ALARM2_SPEED, adapter.getKSAlarm2Speed());
                data.put("" + GarminConnectIQ.MESSAGE_KEY_ALARM3_SPEED, adapter.getKSAlarm3Speed());
            }
